...
${OBJECTDIR}/_ext/d29c42da/battery.o: ../User/battery.c
	${MKDIR} -p ${OBJECTDIR}/_ext/d29c42da
	${RM} "$@.d"
	$(COMPILE.c) -Wall -s -DSTM32F030C8T6 -DSTM32F030x8 -DUSE_FULL_LL_DRIVER -I../Drivers -I../Drivers/CMSIS -I../Drivers/CMSIS/Include -I../Drivers/STM32F0xx_HAL_Driver/Inc -I../Drivers/STM32F0xx_HAL_Driver/Src -I../Middlewares -I../Peripherals -I../Interfaces -I../User -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d29c42da/battery.o ../User/battery.c
