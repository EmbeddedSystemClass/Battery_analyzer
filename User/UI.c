...
//    static uint32_t charging_sec_t0;
    ...
    switch (Battery_getState())
    {
        case STOP: 
            ...
            break;
        case CHARGE: 
             smart_siprintf(textbuff, "Napeti: %d.%02dV",battery_Uget()/1000,battery_Uget()%1000);
             UG_PutString(10, 0, textbuff);
             smart_siprintf(textbuff, "Nabijeci proud: %d.%02dA",battery_Icharge_get()/1000,battery_Icharge_get()%1000);
             UG_PutString(10, 15, textbuff);
             smart_siprintf(textbuff, "Nabijeta kapacita: %d.%02dAh",10,5);
             UG_PutString(10, 30, textbuff);
            break;
        case DISCHARGE: 
             smart_siprintf(textbuff, "Napeti: %d.%02dV",battery_Uget()/1000,battery_Uget()%1000);
             UG_PutString(10, 0, textbuff);
             smart_siprintf(textbuff, "Vybijeci proud: %d.%02dA",battery_Idischarge_get()/1000,battery_Idischarge_get()%1000);
             UG_PutString(10, 15, textbuff);
             smart_siprintf(textbuff, "Vybita kapacita: %d.%02dAh",11,6);
             UG_PutString(10, 30, textbuff);
            break;
    }
